...
! function(e) {
    ...
    var __WEBPACK_IMPORTED_MODULE_0__lib_user_message__ = __webpack_require__(1),
        ...
        __WEBPACK_IMPORTED_MODULE_6__lib_omikuji__ = __webpack_require__(7),
        ...
        LiveBroadcast = function LiveBroadcast(param) {
            ...
            function do_archive() {
                ...
                if (self.clock.is_reach(e["time_lapse"])) {
                    set_queue(e);
                    null == archive_manager.doNext() && console.log("end.")
                }
                exec_queue()
            }
            ...
            function exec_queue() {
                ...
                if (null != e)
                    ...
                    null != t ? (self.idol_message.setEmotion(e.expression_type, e.motion_type, e.effect_type), 90 == e.motion_type && setTimeout(function() {
                        ...
                        self.idol_message.hideIdolMessage(0, !1)
                    }, 300)) : archive_manager.layerOnAirAt - 1 < self.clock.get_time_lapse_ms() && archive_manager.speakAfterOnAirAt - 1 > self.clock.get_time_lapse_ms() ? self.idol_message.hideIdolMessage(0, !1) : (self.idol_message.show(e), self.idol_message_log.add(e))
                } else "" != e.message ? ("" == e.nickname && (e.nickname = e.send_user_name), self.user_message.flush(e.message, e.send_viewer_id == viewer_id), self.user_message_log.add(e)) : "" != e.json_layer_effects ? (layer_effects = JSON.stringify(e.json_layer_effects), layer_set_id = e.layer_effects_set_id, set_layer(layer_effects, layer_set_id), (6 == self.layer_manager.before_layer_set_id && 2 == self.layer_manager.layer_set_id || 106 == self.layer_manager.before_layer_set_id && 102 == self.layer_manager.layer_set_id) && self.idol_message.hideIdolMessage(0, !1)) : null != e["admin_setting[close_time]"] ? self.clock.set_close_time(e["admin_setting[close_time]"]) : null != e["nice_comment_count"] ? viewer_id == e.send_viewer_id && self.idol_message.setNiceComment(e["nice_comment_count"]) : null != e.stamp_id && (e.send_viewer_id == viewer_id ? self.omikuji.cjs_root.run(e.stamp_id - 1) : self.omikuji.showOthers(e.stamp_id, e.send_viewer_id == viewer_id))
            }
            ...
            init_network(), this.log_view.init(this.user_message_log, this.idol_message_log), $.when(def_layer, def_canvas, def_idol_message, def_telop).done(function() {
                ...
                requirejs(cjs_list, function() {
                    ...
                    }, !1), canvas2.init(t[0], manifest, lib, null, fps_18_ms, function() {
                        cjs_roots["draw_lots"] = canvas2.addChild("cjs005_omikuji"), canvas2.stage.update(), setInterval(function() {
                            canvas2.stage.update()
                        }, fps_18_ms), self.omikuji.init(cjs_roots["draw_lots"])
    ...
    var i = function() {
        function e(t, s, i, a) {
            _classCallCheck(this, e), this.intervalMessage = null, this.ReStartMessage = null, this.current_expression_type = 0, this.current_motion_type = 0, this.hideMessageIntervalHandler = null, this.$idol_comment = $("#js_idol_comment"), this.$hide_idol_text = $(".js_hide_idol_text"), this.enable_animation = !0, this.idol_message_speed = $("#layer_idol_comment").data("mes_speed"), this.idol_message_wait_1 = $("#layer_idol_comment").data("mes_wait_1"), this.idol_message_wait_2 = $("#layer_idol_comment").data("mes_wait_2"), this.balloon_direction = 0, this.nice_count = void 0 === a ? 0 : a, this.mode = s, this.live_bc_id = i, this.is_idol_hidden = !1, "hidden" == this.mode && this.setIdolHidden(t), this.is_idol_changed = !1, "changed" == this.mode && this.setIdolChanged(t)
        }
        return _createClass(e, [{
            key: "init",
            ...
            value: function(e) {
                var t = this,
                    ...
                    a = this;
                if (clearTimeout(this.hideMessageIntervalHandler), this.appearIdolMessage(s), this.current_expression_type = e.expression_type, this.current_motion_type = e.motion_type, this.balloon_direction = 8 == this.current_expression_type ? 1 : 0, i) {
                    var _ = this.current_expression_type;
                    "hidden" == this.mode && (this.is_idol_hidden ? this.balloon_direction = 1 : (_ = 9 == this.current_expression_type ? 1 : this.current_expression_type, this.setEmotion(_, 0, 0))), "changed" == this.mode && (this.is_idol_changed ? this.setEmotion(0, 81, 0) : (_ = 13 == this.current_expression_type ? 7 : this.current_expression_type, this.setEmotion(_, 0, 0))), "nice_hidden" == this.mode && (this.is_idol_hidden ? this.balloon_direction = 1 : (_ = 9 == this.current_expression_type ? 1 : this.current_expression_type, this.setEmotion(_, 0, 0)), this.cjs_root_idol.cjs001_character.like_count_up(this.nice_count, 0)), this.mode || this.setEmotion(_, 0, 0)
                } else this.is_idol_hidden ? this.setEmotion(0, 91, 0) : this.is_idol_changed ? this.setEmotion(0, 81, 0) : this.setEmotion(this.current_expression_type, this.current_motion_type, 0);
                if (this.setExpression(this.current_expression_type, this.current_motion_type, s, i), void 0 != e.message) {
                    var n = e.message.replace(/(\r\n|\n|\r)/gm, "<br>");
                    this.setFlowMessage(n, s), s ? this.enable_animation || this.hideIdolMessage(1e4, !0) : this.hideIdolMessage(5e3, !0), this.$hide_idol_text.html(n), setTimeout(function() {
                        var e = a.$hide_idol_text.height(),
                            s = Math.floor(e / 14);
                        s <= 3 ? a.cjs_root.cjs004_balloon.line_num(0, t.balloon_direction) : 4 == s ? a.cjs_root.cjs004_balloon.line_num(1, t.balloon_direction) : s >= 5 && a.cjs_root.cjs004_balloon.line_num(2, t.balloon_direction), a.$idol_comment.css({
                            height: e
                        })
                    }, 0)
                }
            ...
            value: function(e, t, s) {
                if (9999 != this.live_bc_id && 1 != this.live_bc_id)
                    if (this.enable_animation) this.cjs_root_idol.cjs001_character.detail_select(parseInt(e), parseInt(t), parseInt(s));
                    else {
                        var i = t,
                            a = e;
                        "hidden" == this.mode && (90 == i || (i = this.is_idol_hidden ? 91 : 0)), "changed" == this.mode && (i = this.is_idol_changed ? 81 : 0, 13 != e && 82 != t || (a = 7)), this.cjs_root_idol.cjs001_character.detail_select(parseInt(a), parseInt(i), 0)
                    }
            }
        }, {
            key: "setEmotionOld",
            ...
            key: "setNiceComment",
            value: function(e, t) {
                this.enable_animation && this.cjs_root_idol.cjs001_character.like_count_up(parseInt(e), void 0 === t ? 1 : t)
            }
        }, {
            key: "setFlowMessage",
            value: function(e) {
    ...
    var i = function() {
        function e(t, s) {
            _classCallCheck(this, e), this.message_list = null, this.max_log_message_num = t, this.$view = s, this.counter = 0
        }
        return _createClass(e, [{
            key: "init",
            value: function(e) {
            ...
            value: function(e) {
                if (null != this.message_list && this.message_list.length >= this.max_log_message_num && (this.message_list = this.message_list.slice(0, -1)), this.message_list.unshift(e), null != this.$view) {
                    var t = this.$view.children(),
                        s = this.counter % 2,
                        i = null;
                    t.length >= this.max_log_message_num && t.last().remove(), i = $("<div class='log_message'>" + e.message + "</div>"), s && i.addClass("_even"), this.$view.prepend(i)
                }
                this.counter++
            }
        }, {
            ...
            value: function(e) {
                ...
                $.ajax({
                    ...
                    success: function(s) {
                        ...
                        var _ = s.archives[1];
                        null != _ && 1 == _.archive_id && (i.first_layer_effects = JSON.stringify(_.json_layer_effects));
            ...
            value: function() {
                for (var e = null, t = this.current_archive_id; t >= 0; t--)
                    if (5 == this.getArchiveType(t) && this.archives[t].time_lapse >= this.clock.prev_limit) {
                        e = JSON.stringify(this.archives[t].json_layer_effects);
                        break
    ...
    var i = function() {
        ...
        return _createClass(e, [{
            ...
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (e.length <= 0) return void console.warn("no enquete result info");
                this.enquete_detail_model.set({
                    enquete_type: e.enquete_type,
                    enquete_title: e.enquete_title,
                    enquete_list: e.answer_list,
    ...
    var i = function() {
        function e(t) {
            _classCallCheck(this, e), this.$btn_omikuji_start = $("#btn_omikuji_start"), this.api_url = t, this.restrict_msec = 1e4, this.submittable = !0, this.displayedNum = 0
        }
        return _createClass(e, [{
            key: "init",
            value: function(e) {
                var t = this,
                    ...
                    i = 0,
                    a = this;
                this.cjs_root = e.cjs005_omikuji, this.$btn_omikuji_start.on("click", function() {
                    setTimeout(function() {
                        0 != a.submittable && (a.submittable = !1, a.$btn_omikuji_start.addClass("_disabled").html("占い中…"), $.ajax({
                            url: a.api_url,
                            type: "get",
                            data: {},
                            success: function(e) {
                                t.cjs_root.run(e.fortune_id - 1);
                                var _ = "";
                                if (0 == e.result) {
                                    switch (e.error_code) {
                                        case 2:
                                        ...
                                        case 5:
                                            ...
                                            break;
                                        case 7:
                                            _ = "送信が制限されています。<br>前回の送信から" + t.restrict_msec / 1e3 + "秒待って送信してください。";
                                            break;
                                        default:
                                            _ = "送信に失敗しました。<br>error code:" + e.error_code + "<br>もう一度時間を置いて送信してください。"
                                    }
                                    return new Commonjs.Popup("popup-error").set({
                                        title: "エラー",
                                        contents: _
                                    }).open(), a.submittable = !0, void a.$btn_omikuji_start.removeClass("_disabled _text_limit").text("おみくじ")
                                }
                                a.$btn_omikuji_start.addClass("_disabled").text("結果が出ました!"), s = setInterval(function() {
                                    i += 1e3, a.$btn_omikuji_start.addClass("_disabled _text_limit").html("おみくじが引けるまであと<span class='yellow' style='font-size:13px;margin-left:2px'>" + (a.restrict_msec - i) / 1e3 + "</span> 秒"), i >= a.restrict_msec && (clearInterval(s), a.submittable = !0, i = 0, a.$btn_omikuji_start.removeClass("_disabled _text_limit").text("おみくじ"))
                                }, 1e3)
                            },
                            error: function() {
                                alert("通信に失敗しました"), a.submittable = !0, a.$btn_omikuji_start.removeClass("_disabled _text_limit").text("おみくじ")
                            }
                        }))
                    }, 100)
                })
                            ...
                            if (a >= 0) {
                                ...
                                ! function() {
                                    function t(e) {
                                        var a = (e - i) / 75,
                                            _ = d * Math.cos(l) * a,
                                            n = Math.tan(l) * _ - u / (2 * d * d * Math.cos(l) * Math.cos(l)) * _ * _,
                                            r = 0;
                                        r = c.left > o.left ? -_ : _, s.css({
                                            left: Math.round(c.left + r) + "px",
                                            top: Math.round(c.top - n) + "px"
                                        }), c.top - n < o.top ? requestAnimationFrame(t) : (s.remove(), window.live_broadcast.omikuji.displayedNum--)
                                    }
                                    window.live_broadcast.omikuji.displayedNum++, $('<div class="omikuji-paper"><div class="omikuji"></div></div>').prependTo("#layer_user_comment");
                                    var s = $(".omikuji-paper").first();
                                    s.css({
                                        left: c.left + "px",
                                        top: c.top + "px"
                                    }), s.find(".omikuji").addClass("radio_omikuji_0" + (e - 1));
